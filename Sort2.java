...
public class Sort2 {
    ...
    /*
     * swap - swap the values of arr[a] and arr[b]. Used by several of the sorting
     * algorithms below.
     */
     ...
     * from arr[start] to the end of the array. Used by selectionSort.
     */
    ...
    public static void shellSort(int[] arr) {
        /*
         * Find initial increment: one less than the largest power of 2 that is <= the
         * number of objects.
         */
        int incr = 1;
    ...
    public static void main(String[] arr) { 
        ...
        /* insertion sort */
        // System.arraycopy(orig, 0, copy, 0, orig.length); 
        // int[] temp =  {48, 26, 20, 10, 12, 42, 18, 16};
        // insertionSort(temp);
        ...
        /* mergesort */
        //System.arraycopy(orig, 0, copy, 0, orig.length); 
        int[] arr1 ={35, 13, 56, 15, 30, 17, 46, 57};
        mergeSort(arr1);
        System.out.print("mergesort:\t");
        printArray(arr1);
        System.out.println("mergecount"+count);
    }
